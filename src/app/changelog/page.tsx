...
const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    changes: [
      ...
      { type: "fixed", text: "The Stat Optimizer no longer refuses the Hyper Stat levels you type when no character is selected." },
      { type: "fixed", text: "The Stat Optimizer now tells you to set your level instead of showing a 0% Hyper Stat gain when you have no points to spend." },
      { type: "fixed", text: "The Stat Optimizer no longer says your HEXA Stats are already optimized when you have not filled in any cores." },
      { type: "changed", text: "The Stat Optimizer no longer guesses a stat type next to Main Stat and Secondary Stat when no character is selected." },
