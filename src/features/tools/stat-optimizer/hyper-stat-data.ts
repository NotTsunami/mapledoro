/*
  Bossing-relevant Hyper Stat data, matching maplescouter's optimizer tables
  ...
  bossing: Normal Damage, EXP, Status Resistance, HP/MP, class-resource stats,
  Arcane Power.
*/
...
/**
 * Candidate lines in maplescouter's exact iteration order (their S1/qX lists).
 * subStat2 only applies to classes with a second secondary stat (Dual Blade,
 * Shadower, Cadena, Xenon); the engine filters it out for everyone else.
 */
